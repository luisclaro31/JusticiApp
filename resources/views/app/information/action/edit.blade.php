...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Accion</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                {!! Form::model($result,  ['route' => ['info.action.update', $result], 'method' => 'PUT']) !!}
                                ...
                                {!! Form::open(['route' => ['info.action.destroy', $result], 'method' => 'DELETE' ]) !!}
                                    <br>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($results as $result)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info btn-sm" href="{{ route('info.action.edit', $result)  }}">Editar <i class="fa fa-pencil fa-lg"></i> o <i class="fa fa-trash fa-lg"></i> Eliminar</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
