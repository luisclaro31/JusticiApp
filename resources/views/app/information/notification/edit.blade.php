                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                {!! Form::model($result,  ['route' => ['info.notification.update', $result], 'method' => 'PUT']) !!}
                                ...
                                {!! Form::open(['route' => ['info.notification.destroy', $result], 'method' => 'DELETE' ]) !!}
                                    <br>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($results as $result)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info btn-sm" href="{{ route('info.notification.edit', $result)  }}">Editar <i class="fa fa-pencil fa-lg"></i> o <i class="fa fa-trash fa-lg"></i> Eliminar</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
