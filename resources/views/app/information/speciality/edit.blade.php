                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                {!! Form::model($result,  ['route' => ['info.speciality.update', $result], 'method' => 'PUT']) !!}
                                ...
                                {!! Form::open(['route' => ['info.speciality.destroy', $result], 'method' => 'DELETE' ]) !!}
                                    <br>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                @foreach($results as $result)
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info btn-sm" href="{{ route('info.speciality.edit', $result)  }}">Editar <i class="fa fa-pencil fa-lg"></i> o <i class="fa fa-trash fa-lg"></i> Eliminar</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
