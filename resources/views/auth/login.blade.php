        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    @if ( count($errors) > 0)
                        <p><h4 align="center"><span class="label label-danger">Error De Email o contraseña</span></h4></p>
                    @else
                        <p class="login-box-msg">Inicio de Seccion Para Clientes</p>
                    @endif
                </div>
                <div class="panel-body">
                    {!! Form::open(['method' => 'POST', 'url' => '/login', 'novalidate' ]) !!}
                        <fieldset>
